    ...
    class GestorTabla
    {
        ...
        public void CompletarTabla(double[,] datos)
        {
            ...
            for (uint i = 0; i < datos.GetLength(0); i++)
            {
                ...
                tabla.Rows[fila].Cells[3].Value = CadenaAuxiliarTabla(datos[i, 3]);
                tabla.Rows[fila].Cells[4].Value = CadenaAuxiliarTabla(datos[i, 4]);
                tabla.Rows[fila].Cells[5].Value = CadenaAuxiliarTabla(datos[i, 5]);
                tabla.Rows[fila].Cells[6].Value = StringTieneFicha(datos[i, 6]);
                tabla.Rows[fila].Cells[7].Value = CadenaAuxiliarTabla(datos[i, 7]);
                tabla.Rows[fila].Cells[8].Value = CadenaAuxiliarTabla(datos[i, 8]);
                tabla.Rows[fila].Cells[9].Value = CadenaAuxiliarTabla(datos[i, 9]);
                tabla.Rows[fila].Cells[10].Value = CadenaAuxiliarTabla(datos[i, 10]);
                tabla.Rows[fila].Cells[11].Value = CadenaAuxiliarTabla(datos[i, 11]);
                tabla.Rows[fila].Cells[12].Value = CadenaAuxiliarTabla(datos[i, 12]);
                tabla.Rows[fila].Cells[13].Value = CadenaAuxiliarTabla(datos[i, 13]);
                tabla.Rows[fila].Cells[14].Value = CadenaAuxiliarTabla(datos[i, 14]);
                tabla.Rows[fila].Cells[15].Value = CadenaAuxiliarTabla(datos[i, 15]);
                tabla.Rows[fila].Cells[16].Value = StringEstadoCalecita(datos[i, 16]);
                ...
                tabla.Rows[fila].Cells[24].Value = CadenaAuxiliarTabla(datos[i, 24]);
